...
def decision():
    if request.method == 'POST':
        ...
        if decision == 'accept':
	    	...
	    	{
			"type": "text/plain",
			"value": "We are pleased to confirm your appointment with Dr. Kumar at Apollo Clinic on 22/05/2023 at 6:00 pm. We appreciate your trust in our healthcare services and look forward to providing you with exceptional care."
		    }
	        ]
            }
